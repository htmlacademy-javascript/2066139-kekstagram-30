import {getRandomInteger, createRandomIdFromRange, getRandomArrayElement} from './util';
...
const createUserPhoto = (index) => ({
  ...
  comments: Array.from({length: getRandomInteger(0, COMMENTS_IN_POST_MAX_COUNT)}, createComment),
});
